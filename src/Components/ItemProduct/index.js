...
const ItemProduct = ({itemProduct}) => {
    ...
    function AddToCar(_product) {
        if(!!!isBuy){ // Verificar se o item já esta no carrinho 
            addItemCar({
                "amount": amount, 
        ...
        <View style={[styles.container, isBuy && styles.buy]}>
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <View style={styles.groupText}>
                            ...
                            {!!itemProduct.promotion && <Text style={styles.textValuePromotion}> por {formatMoney(itemProduct.pricePromotion)}</Text>}
                        </View>
                        ...
                        <View style={styles.containerButtonAdd}>
                            ...
                            <TouchableOpacity style={styles.buttonComprar} onPress={()=> AddToCar(itemProduct)}>
            ...
            <BorderlessButton onPress={handleInformedModal}>
                ...
                <View style={styles.description}>
                    <Text style={styles.titleDescription}>{itemProduct.name}</Text>
                </View>
                <View style={styles.priceContent}>
                    <Text style={itemProduct.promotion ? styles.textValuePromotion : styles.textPrice}>
