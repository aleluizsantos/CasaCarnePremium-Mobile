...
export const RequestProvider = ({ children }) => {
    ...
    function SumItemCart(_item) {
        const price = _item.amount * (_item.promotion ? _item.pricePromotion : _item.price);
    ...
    async function upAmountProduct(_itemCar){
        ...
        const valueAmount = (_itemCar.promotion ? _itemCar.pricePromotion : _itemCar.price) * 0.5;
